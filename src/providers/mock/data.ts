...
export const mockEventTypes: EventType[] = [
  {
    id: 'party',
    name: 'Private Party',
    description: 'Celebrate anything with a hands-on craft party — every guest makes a piece to take home.',
    category: 'party',
    duration: 90,
    baseCapacity: 10,
    maxCapacity: 30,
    flow: 'booking',
    variations: [
      { id: 'party-base', name: 'Studio Fee (up to 10 guests)', priceAmount: 30000, priceCurrency: 'USD' },
    ],
    modifiers: [],
  },
  {
    ...
    flow: 'booking',
    variations: [
      { id: 'party-group-base', name: 'Studio Fee (up to 10 guests)', priceAmount: 30000, priceCurrency: 'USD' },
    ],
    modifiers: [],
  },
  {
  ...
  // Party craft types (whole-room, occasion-neutral)
  {
    id: 'kids-slime',
    name: 'Slime Party',
